...
export function TerminolAdapter({
	...
	return (
		...
		<div
			className={cn(
				"z-0 h-full max-h-[400px] w-full max-w-lg rounded-xl border border-border bg-background relative overflow-hidden flex flex-col",
				theme?.container,
				className,
			)}
		...
		>
			...
			{/* Header Logic: Use provided header or default mac-style dots */}
			{header !== undefined ? (
				header
			) : (
			...
			<pre className="p-4 flex-1 min-h-0 overflow-hidden">
				<code className="h-full block overflow-hidden p-0 grid gap-y-1">
					<div
						ref={scrollRef}
